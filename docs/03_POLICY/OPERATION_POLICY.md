...
## 3-A. PCS 운전 가능 여부 (Operable)

PCS 운전 가능 여부는  
**충·방전 제어 및 Scheduler의 최상위 Gate** 이다.

본 값은 PCS 단일 기준으로 판단되며,  
다른 모든 운전 조건 판단에 **선행**한다.

---

### 3-A.1 판단 기준

다음 조건을 **모두 만족해야** 운전 가능으로 판정한다.
